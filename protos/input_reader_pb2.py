...
_INPUTREADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='label_map_path', full_name='protos.InputReader.label_map_path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='protos.InputReader.shuffle', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='queue_capacity', full_name='protos.InputReader.queue_capacity', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_after_dequeue', full_name='protos.InputReader.min_after_dequeue', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_epochs', full_name='protos.InputReader.num_epochs', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='num_readers', full_name='protos.InputReader.num_readers', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='load_instance_masks', full_name='protos.InputReader.load_instance_masks', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='protos.InputReader.tf_record_input_reader', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='protos.InputReader.external_input_reader', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='input_reader', full_name='protos.InputReader.input_reader',
...
_TFRECORDINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='protos.TFRecordInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_path', full_name='protos.TFRecordInputReader.input_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXTERNALINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='protos.ExternalInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:protos.InputReader)
  })
...
TFRecordInputReader = _reflection.GeneratedProtocolMessageType('TFRecordInputReader', (_message.Message,), {
  ...
  '__module__' : 'protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:protos.TFRecordInputReader)
  })
...
ExternalInputReader = _reflection.GeneratedProtocolMessageType('ExternalInputReader', (_message.Message,), {
  ...
  '__module__' : 'protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:protos.ExternalInputReader)
  })
